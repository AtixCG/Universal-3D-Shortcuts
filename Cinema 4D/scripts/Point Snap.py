...
def main() -> None:
    ...
    if point == 1:
        if en == 0:
            ...
            data[c4d.SNAPMODE_POINT] = 0
            if edge == 0 and polygon == 0 and spline == 0 and axis == 0 and inter == 0 and midpoint==0 and workplane == 0 and guide == 0:
                data[c4d.SNAP_SETTINGS_ENABLED] = 0
    else:
        data[c4d.SNAP_SETTINGS_ENABLED] = 1
        data[c4d.SNAPMODE_POINT]=1
