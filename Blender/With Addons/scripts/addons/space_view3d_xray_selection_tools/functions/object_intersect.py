...
def get_ob_2dbboxes(mesh_obs, mesh_ob_count, region, rv3d):
    ...
    ob_2dbbox_points = np.column_stack((
        ob_2dbbox_xmin, ob_2dbbox_ymin,
        ob_2dbbox_xmin, ob_2dbbox_ymax,
        ob_2dbbox_xmax, ob_2dbbox_ymax,
        ob_2dbbox_xmax, ob_2dbbox_ymin)).reshape(mesh_ob_count * 4, 2)

    # create segments of object 2d bboxes
    ob_2dbbox_segments = np.column_stack((
        ob_2dbbox_xmin, ob_2dbbox_ymin, ob_2dbbox_xmin, ob_2dbbox_ymax,
        ob_2dbbox_xmin, ob_2dbbox_ymax, ob_2dbbox_xmax, ob_2dbbox_ymax,
        ob_2dbbox_xmax, ob_2dbbox_ymax, ob_2dbbox_xmax, ob_2dbbox_ymin,
        ob_2dbbox_xmax, ob_2dbbox_ymin, ob_2dbbox_xmin, ob_2dbbox_ymin)).reshape(mesh_ob_count * 4, 2, 2)

    # get mask of entirely clipped bboxes
    obs_mask_2dbbox_entire_clip = np.all(ob_3dbbox_co_2d_mask_clip, axis=1)

    return ob_2dbbox_xmin, ob_2dbbox_xmax, ob_2dbbox_ymin, ob_2dbbox_ymax, ob_2dbbox_points, ob_2dbbox_segments, \
...
def do_selection(mask_of_obs_to_select, obs_to_select, mode):
    ...
    for i, ob in enumerate(obs_to_select):
        ob.select_set(select[i])
